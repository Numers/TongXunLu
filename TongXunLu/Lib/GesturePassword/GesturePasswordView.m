...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        UIView * view = [[UIView alloc]initWithFrame:CGRectMake(frame.size.width/2-160, 140, 320, 320)];
        for (int i=0; i<9; i++) {
            NSInteger row = i/3;
            NSInteger col = i%3;
            // Button Frame
...
//        frame.origin.y=0;
        ...
        state = [[UILabel alloc]initWithFrame:CGRectMake(frame.size.width/2-140, 100, 280, 30)];
        ...
        forgetButton = [[UIButton alloc]initWithFrame:CGRectMake(frame.size.width/2-150, frame.size.height-40, 120, 30)];
        ...
        changeButton = [[UIButton alloc]initWithFrame:CGRectMake(frame.size.width/2+30, frame.size.height-40, 120, 30)];
