...
-(void)ImageSetting
{
    ZBMessageShareMenuItem *sharePicItem = [[ZBMessageShareMenuItem alloc]initWithNormalIconImage:[UIImage imageNamed:@"sharemore_pic_ios7@2x.png"]
                                                                                            title:@"照片"];
    ZBMessageShareMenuItem *shareVideoItem = [[ZBMessageShareMenuItem alloc]initWithNormalIconImage:[UIImage imageNamed:@"sharemore_video_ios7@2x.png"]
                                                                                              title:@"拍摄"];
    ...
    ZBMessageShareMenuItem *shareVoipItem = [[ZBMessageShareMenuItem alloc]initWithNormalIconImage:[UIImage imageNamed:@"sharemore_videovoip@2x.png"]
                                                                                             title:@"视频聊天"];
    self.shareMenuItems = [NSArray arrayWithObjects:sharePicItem,shareVideoItem,shareLocItem,shareVoipItem, nil];
}
...
- (void)setup{
    ...
    if (!_shareMenuScrollView) {
        NSLog(@"%lf,%lf",CGRectGetWidth(self.bounds),CGRectGetHeight(self.bounds));
